  ...
  },
  {
    ...
    content: `
      ...
      <ul class="list-disc pl-6 mb-4">
        ...
        <li class="mb-2">Reconocimiento y recompensa a comportamientos seguros</li>
        <li class="mb-2">Participación activa de todos los niveles jerárquicos en las iniciativas de seguridad</li>
        <li class="mb-2">Comunicación constante de métricas y objetivos de seguridad</li>
      </ul>
      
      <h3 class="text-xl font-bold mt-6 mb-3">Conclusiones</h3>
      
      <p class="mb-4">La gestión de seguridad en minas subterráneas ha evolucionado significativamente en las últimas décadas, pasando de un enfoque reactivo a uno proactivo y preventivo. La combinación de tecnologías avanzadas de monitoreo, comunicación y formación, junto con una sólida cultura organizacional centrada en la seguridad, está transformando la industria.</p>
      
      <p class="mb-4">Las empresas mineras que lideran en seguridad no solo protegen la vida de sus trabajadores, sino que también experimentan mejoras significativas en productividad y eficiencia operacional. La seguridad y la rentabilidad ya no son objetivos contrapuestos, sino complementarios.</p>
      
      <div class="bg-mining-50 dark:bg-mining-900/20 p-4 rounded-lg mt-8">
        <h4 class="font-bold text-mining-700 dark:text-mining-300">Formación especializada en seguridad minera</h4>
        <p class="text-mining-600 dark:text-mining-400">Descubre nuestros programas de capacitación en gestión de seguridad para operaciones mineras subterráneas.</p>
      </div>
    `,
    ...
    author: {
      ...
      bio: "Ingeniero en Minas con especialización en Seguridad Ocupacional. 20 años de experiencia en operaciones subterráneas de gran escala en Perú, Chile y México. Consultor en implementación de sistemas de gestión de seguridad para minería.",
    ...
    readTime: "9 min",
    comments: 17,
    tags: ["Seguridad", "Minería Subterránea", "Prevención", "Tecnología", "Capacitación"],
    relatedCourses: [
      {
        id: "course-4",
        title: "Seguridad y Prevención de Riesgos en Minería",
      ...
      {
        id: "course-5",
        title: "Gestión Avanzada de Seguridad en Operaciones Subterráneas",
        image: "https://images.unsplash.com/photo-1582584001264-d8efbf406ab6?auto=format&fit=crop&w=800&q=80"
      }
    ]
  }
...
export const recentPosts: BlogPost[] = [
  {
    id: "3",
    title: "Optimización de Procesos Mineros con Machine Learning",
    excerpt: "Cómo los algoritmos de aprendizaje automático están transformando la eficiencia operativa en la industria minera.",
    content: `
      <div class="mb-6">
        <img src="https://images.unsplash.com/photo-1516192518150-0d8fee5425e3?auto=format&fit=crop&w=1400&q=80" alt="Machine Learning en Minería" class="w-full h-auto rounded-lg mb-4" />
        <p class="text-sm text-gray-600 dark:text-gray-400">Analítica avanzada aplicada a operaciones mineras</p>
      </div>
      
      <p class="mb-4">La industria minera está viviendo una revolución silenciosa impulsada por el machine learning y la analítica avanzada. Las empresas que aprovechan estas tecnologías están logrando mejoras significativas en eficiencia, seguridad y rentabilidad.</p>
      
      <h2 class="text-2xl font-bold mb-4">Transformando la Operación Minera con IA</h2>
      
      <p class="mb-4">Los algoritmos de aprendizaje automático están optimizando cada aspecto del proceso minero, desde la exploración hasta el procesamiento del mineral. Algunas aplicaciones destacadas incluyen:</p>
      
      <ul class="list-disc pl-6 mb-6">
        <li class="mb-2">Predicción de fallos en equipos críticos antes de que ocurran</li>
        <li class="mb-2">Optimización de rutas para flotas de transporte</li>
        <li class="mb-2">Análisis geológico para identificar depósitos de alto potencial</li>
        <li class="mb-2">Control preciso de procesos metalúrgicos</li>
      </ul>
      
      <p class="mb-4">Esta revolución tecnológica está permitiendo a las compañías mineras hacer más con menos, reduciendo costos operativos mientras aumentan la producción.</p>
    `,
    category: "tecnologia",
    ...
    readTime: "6 min",
    comments: 9,
    tags: ["Tecnología", "Machine Learning", "Eficiencia", "Innovación", "Big Data"]
  },
  {
    id: "4",
    title: "El Impacto del ESG en la Minería Moderna",
    excerpt: "Cómo los criterios ambientales, sociales y de gobernanza están redefiniendo las prácticas mineras globales.",
    content: `
      <p class="mb-4">Los factores ESG (Environmental, Social and Governance) han pasado de ser consideraciones secundarias a imperativos estratégicos en la industria minera moderna. Las empresas están siendo evaluadas no solo por su rendimiento financiero, sino también por su impacto ambiental, responsabilidad social y prácticas de gobernanza.</p>
      
      <h2 class="text-2xl font-bold mb-4">Una Nueva Era para la Minería</h2>
      
      <p class="mb-4">Los inversionistas, reguladores, comunidades y consumidores están exigiendo cada vez más que las operaciones mineras se realicen de manera responsable y sostenible. Esta transformación está impulsando innovaciones significativas en toda la industria.</p>
    `,
    category: "tendencias",
    image: "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=800&q=80",
    author: {
    ...
    readTime: "7 min",
    comments: 15,
    tags: ["ESG", "Sostenibilidad", "Minería Responsable", "Medio Ambiente", "Comunidades"]
  },
  {
    id: "5",
    title: "Avances en Perforación de Precisión para Minería",
    excerpt: "Las últimas tecnologías que están revolucionando la perforación en operaciones mineras.",
    content: `
      <p class="mb-4">La perforación de precisión está transformando la eficiencia y sostenibilidad de las operaciones mineras. Con avances tecnológicos significativos, las compañías pueden ahora extraer recursos con mínima perturbación ambiental y máxima recuperación mineral.</p>
      
      <h2 class="text-2xl font-bold mb-4">Tecnologías de Vanguardia</h2>
      
      <p class="mb-4">Los sistemas de navegación GPS de alta precisión, combinados con sensores avanzados y análisis de datos en tiempo real, permiten una precisión sin precedentes en la perforación minera.</p>
    `,
    category: "investigacion",
    image: "https://images.unsplash.com/photo-1565117639058-7ef3568f0e47?auto=format&fit=crop&w=800&q=80",
    author: "Ricardo Torres",
    date: "4 May, 2025",
    readTime: "5 min",
    comments: 7,
    tags: ["Perforación", "Tecnología", "Precisión", "Innovación", "Automatización"]
  },
  {
    id: "6",
